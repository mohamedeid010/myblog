...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('main/')}}/fonts/ionicons/css/ionicons.min.css">
  ...
  <body>
            ...
            <div class="col-md-12 col-lg-4 sidebar">
              ...
              <div class="sidebar-box">
                <div class="bio text-center">
                  <img src="{{asset('main/')}}/images/person_1.jpg" alt="Image Placeholder" class="img-fluid">
                  <div class="bio-body">
                    <h2>David Craig</h2>
              ...
              <div class="sidebar-box">
                ...
                <div class="post-entry-sidebar">
                  <ul>
                    <li>
                      <a href="">
                        <img src="{{asset('main/')}}/images/img_2.jpg" alt="Image placeholder" class="mr-4">
                        <div class="text">
                    ...
                    <li>
                      <a href="">
                        <img src="{{asset('main/')}}/images/img_4.jpg" alt="Image placeholder" class="mr-4">
                        <div class="text">
                          <h4>How to Find the Video Games of Your Youth</h4>
                          <div class="post-meta">
                            <span class="mr-2">March 15, 2018 </span>
                    ...
                    <li>
                      <a href="">
                        <img src="{{asset('main/')}}/images/img_12.jpg" alt="Image placeholder" class="mr-4">
                        <div class="text">
                          <h4>How to Find the Video Games of Your Youth</h4>
                          <div class="post-meta">
                            <span class="mr-2">March 15, 2018 </span>
        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-md-4">
              <h3>About Us</h3>
              <p class="mb-4">
                <img src="{{asset('main/')}}/images/img_1.jpg" alt="Image placeholder" class="img-fluid">
              </p>
                ...
                <div class="col-md-7">
                  ...
                  <div class="post-entry-sidebar">
                    <ul>
                      <li>
                        <a href="">
                          <img src="{{asset('main/')}}/images/img_6.jpg" alt="Image placeholder" class="mr-4">
                          <div class="text">
                            <h4>How to Find the Video Games of Your Youth</h4>
                            <div class="post-meta">
                      ...
                      <li>
                        <a href="">
                          <img src="{{asset('main/')}}/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                          <div class="text">
                            <h4>How to Find the Video Games of Your Youth</h4>
                            <div class="post-meta">
                              <span class="mr-2">March 15, 2018 </span> &bullet;
    ...
    <script src="{{asset('main/')}}/js/jquery-migrate-3.0.0.js"></script>
